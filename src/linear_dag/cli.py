...
def _main(args):
    ...
    run_forward_backward_p = subp.add_parser(
        "run-forward-backward", help="Step 2.1 of partition and merge pipeline. Runs forward and backward passes on genotype matrix to obtain the forward and backward graphs."
    )
